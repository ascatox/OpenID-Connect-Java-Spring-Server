	...
	public String providerConfiguration(Model model) {
		...
		/*
		    ...
		    request_object_signing_alg_values_supported
		        ...
		        the ObjectRequestDir Object described in Section 2.9 of OpenID Connect Messages 1.0 [OpenID.Messages]. These algorithms are used both when
		        the ObjectRequestDir Object is passed by value (using the request parameter) and when it is passed by reference (using the request_uri parameter).
		    ...
		    request_object_encryption_alg_values_supported
		        ...
		        the ObjectRequestDir Object described in Section 2.9 of OpenID Connect Messages 1.0 [OpenID.Messages]. These algorithms are used both when
		        the ObjectRequestDir Object is passed by value and when it is passed by reference.
